...
| Field | Value |
|---|---|
| `batch_report_id` | `BER-20260504-161712` |
| `generated_at` | `2026-05-04T16:17:12+09:00` |
| `candidate_count` | `4` |
...
|---:|---|---|---|---|---:|---|
| 1 | `WEB-006` | MISUMI Korea | `recommend` | `Low` | 96 | 원본 자재와 후보 자재의 재질이 동일합니다. |
| 2 | `WEB-007` | Daara Precision | `conditional_approve` | `Medium` | 84 | 재질이 SUS304에서 SUS316으로 상향되어 사용 가능성은 있으나 비용과 현장 조건 확인이 필요합니다. |
| 3 | `WEB-008` | Open Market Seller | `review_required` | `High` | 95 | 규격은 유사하지만 출처 신뢰도가 낮아 자동 추천할 수 없습니다. |
| 4 | `WEB-005` | Fastener Tech | `reject` | `High` | 42 | 필수 규격이 일치하지 않아 대체재로 추천하지 않습니다. |

## 5. Explainability Points
