...
한국에서 접속 가능한 국내 사이트를 우선한다. 한국 공식 대리점, 국내 산업재몰, 국내 마켓플레이스 중 가격, 재고, 납기, 데이터시트가 표시될 가능성이 높은 페이지를 찾는 데 집중한다.
...
- 검색어에는 가능하면 Korea, Korean distributor, 국내, 한국, 대리점, site:.kr 같은 국내 사이트 신호를 포함한다.
